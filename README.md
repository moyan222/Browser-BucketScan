...
- **历史记录**：记录所有检测到的漏洞。
  ![image-20260511014750430](./imgs/image-20260511014750430.png)
...
- **导出功能**：位于扩展弹窗顶部，直接点击按钮即可导出检测历史。
  ...
  - 导出HTML：可视化报告，美观易读
  - 导出内容包含完整的漏洞信息和数据包
  ![image-20260511015007779](./imgs/image-20260511015007779.png)
...
- 2025-12-20
  ...
  - 修复：各云厂商检测文件中缺少开关条件判断的问题
    ...
    ![image-20260511015434707](./imgs/image-20260511015434707.png)
